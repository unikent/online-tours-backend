...
class ContentRelationshipRequestTest extends TestCase {
	...
	protected function setupRequest(){
		$request = new ContentRelationshipRequest;
	...
	protected function setupRequestValidator($attrs){
		...
		$reflector = new ReflectionClass('App\Http\Requests\ContentRelationshipRequest');
	 ...
	 * @group validation
	 */
	public function ownerType_IsNotRequired(){
		$attrs = self::getAttrs();
